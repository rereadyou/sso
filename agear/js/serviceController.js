function SSOController(window, document) {
    ...
    var ssoPreloginURL = "http://sso.allyes.me/prelogin/";//.php";
    var ssoLoginURL = "http://sso.allyes.me/login/";//.php"; //login process page
    var ssoLogoutURL = "http://sso.allyes.me/logout/";//.php";
    var ssoLoginChkURL = "http://sso.allyes.me/login_chk/";//.php";
